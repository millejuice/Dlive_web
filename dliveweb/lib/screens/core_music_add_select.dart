      ...
      children: [
        ...
        Row(
          children: [
            ...
            Container(
              //이미지 들어갈 자리
              width: MediaQuery.of(context).size.width / 375 * 91,
              height: MediaQuery.of(context).size.height / 812 * 62,
              color: Colors.grey,
            ),
            SizedBox(
              width: MediaQuery.of(context).size.width / 375 * 16,
            ),
            Column(
            ...
            SizedBox(
              width: MediaQuery.of(context).size.width / 375 * 141,
            ),
            Container(
              width: 25,
      ...
      body: Container(
        ...
        child: Center(
          child: Column(
            children: [
              SizedBox(
                height: MediaQuery.of(context).size.height / 375 * 10,
              ),
              Container(
                child: TextField(
                ...
                width: MediaQuery.of(context).size.width / 375 * 344,
